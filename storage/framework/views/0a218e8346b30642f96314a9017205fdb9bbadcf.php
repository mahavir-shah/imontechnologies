                ...
                success: function (data) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
							...
							var itemTaxPrice = 0;
                            if (purchaseItems != null) {
                                itemTaxPrice = parseFloat((totalItemTaxRate / 100) * (purchaseItems.price * purchaseItems.quantity));
                            } else {
                                itemTaxPrice = parseFloat((totalItemTaxRate / 100) * (item.product.purchase_price * 1));
                            }

                            $(el.parents('tr').find('.itemTaxPrice')).val(itemTaxPrice.toFixed(2));
                            $(el.parents('tr').find('.itemTaxRate')).val(totalItemTaxRate.toFixed(2));
                            $(el.parents('tr').find('.taxes')).html(taxes);
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/imontechnologies/resources/views/purchase/edit.blade.php ENDPATH**/ ?>