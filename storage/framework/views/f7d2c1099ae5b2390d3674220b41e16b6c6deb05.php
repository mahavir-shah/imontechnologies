                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('purchase_date',date('Y-m-d'),array('class'=>'form-control','required'=>'required'))); ?>
                ...
                <div class="card-body table-border-style">
                    <div class="table-responsive">
                        <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="form-group"><?php echo e(Form::textarea('description', null, ['class'=>'description form-control','rows'=>'2','placeholder'=>__('Description')])); ?></div>
                                </td>
                                <td colspan="5"></td>
                            </tr>
                            </tbody>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/imontechnologies/resources/views/purchase/create.blade.php ENDPATH**/ ?>