        ...
        function changeItem(element) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('purchase.returnItems')); ?>',
                        type: 'GET',
                        headers: {
                            'X-CSRF-TOKEN': jQuery('#token').val()
                        },
                        ...
                        success: function (data) {
                            ...
                            data.goods.map((good) => {
                                if(good.id === purchaseItems.id){
                                    purchaseItems.totalReturnQty = good.totalReturnQty;
                                }
                            })

                            if (purchaseItems != null) {
                                var amount = (purchaseItems.price * purchaseItems.quantity);
                                if(purchaseItems.totalReturnQty != undefined){
                                    var qty = purchaseItems.quantity - purchaseItems.totalReturnQty;
                                    $(el.parent().parent().parent().find('.requiredQty')).val(purchaseItems.quantity);
                                    $(el.parent().parent().parent().find('.returnedQty')).val(qty);
                                    $(el.parent().parent().parent().find('.returningQty')).val(qty);
                                }else{
                                    $(el.parent().parent().parent().find('.requiredQty')).val(purchaseItems.quantity);
                                    $(el.parent().parent().parent().find('.returnedQty')).val(purchaseItems.quantity);
                                    $(el.parent().parent().parent().find('.returningQty')).val(purchaseItems.quantity);
                                }
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <?php echo e(Form::model($purchase, array('route' => array('purchase.addPurchaseReturn', $purchase->id), 'method' => 'POST','class'=>'w-100'))); ?>
        ...
        <div class="col-12">
            <h5 class="d-inline-block mb-4"><?php echo e(__('Purchase Return')); ?></h5>
                    ...
                    <div class="table-responsive">
                        <table class="table  mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(__('Returned qty')); ?></th>
                                <th><?php echo e(__('Returning qty')); ?></th>
                                <th></th>
                            </tr>
                            </thead>
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    ...
                                    <?php echo e(Form::hidden('returned_qty',null, array('class' => 'form-control returnedQty'))); ?>
                                    ...
                                    <td>
                                        <div class="form-group price-input input-group search-form">
                                            <?php echo e(Form::text('required_Qty',null, array('class' => 'form-control quantity requiredQty','disabled','placeholder'=>__('Qty'),'required'=>'required'))); ?>

                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group price-input input-group search-form">
                                            <?php echo e(Form::text('returned_qty',null, array('class' => 'form-control quantity returnedQty','disabled','placeholder'=>__('Qty'),'required'=>'required'))); ?>

                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group price-input input-group search-form">
                                            <?php echo e(Form::text('returning_qty',null, array('class' => 'form-control quantity returningQty','placeholder'=>__('Qty'),'required'=>'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/earthdlp/admin.imontechnologies.in/resources/views/purchase/purchase_return.blade.php ENDPATH**/ ?>