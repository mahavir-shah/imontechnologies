...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Estimate Details')); ?></li>
                        ...
                        <div class="card-body">
                            <div class="row timeline-wrapper">
                                <div class="col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <h6 class="text-primary my-3"><?php echo e(__('Create Estimate')); ?></h6>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit proposal')): ?>
                                        <a href="<?php echo e(route('estimate.edit',\Crypt::encrypt($proposal->id))); ?>" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>"><i class="ti ti-pencil mr-2"></i><?php echo e(__('Edit')); ?></a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <h6 class="text-warning my-3"><?php echo e(__('Send Estimate')); ?></h6>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <h6 class="text-info my-3"><?php echo e(__('Estimate Status')); ?></h6>
                                    <small>
                                        <?php if($proposal->status == 0): ?>
                            ...
                            <div class="row">
                                <div class="col text-end">
                                    <div class="d-flex align-items-center justify-content-end">
                                        <div class="me-4">
                                            <small>
                                                <strong><?php echo e(__('Estimate Date')); ?> :</strong><br>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/imontechnologies/resources/views/proposal/view.blade.php ENDPATH**/ ?>