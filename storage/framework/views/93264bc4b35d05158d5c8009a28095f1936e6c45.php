...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            <?php echo e(Form::label('carrierType', __('Carrier'),['class'=>'form-label'])); ?>

            <?php echo e(Form::select('carrierType', $carrierType,null, array('class' => 'form-control select','disabled','id' => 'carrierType'))); ?>
        ...
        <div class="form-group col-md-6">
            <?php echo e(Form::label('boxType', __('Box Type'),['class'=>'form-label'])); ?>

            <?php echo e(Form::select('boxType', $boxType,null, array('class' => 'form-control select','required'=>'required'))); ?>
...
<?php /**PATH /home1/earthdlp/admin.imontechnologies.in/resources/views/ship/shipping.blade.php ENDPATH**/ ?>