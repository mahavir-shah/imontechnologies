...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Estimate Edit')); ?></li>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::model($proposal, array('route' => array('estimate.update', $proposal->id), 'method' => 'PUT','class'=>'w-100'))); ?>
                                ...
                                <td colspan="2">
                                    <div class="form-group">
                                        ...
                                        <p class="text-success hsn_code"><span>HSN Code: 
                                            <?php echo e(Form::text('hsn_code', null,['class'=>'text-success border-0'])); ?></span></p>
                                    </div>
                                </td>
                                <td colspan="5"></td>
                            </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/imontechnologies/resources/views/proposal/edit.blade.php ENDPATH**/ ?>