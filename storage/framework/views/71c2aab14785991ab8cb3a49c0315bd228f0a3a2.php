                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                                <div class="d-table-th w-22"><?php echo e(__('Product')); ?></div>
                                                <div class="d-table-th w-1"><?php echo e(__('Stock')); ?></div>
                                            </div>
                                                    ...
                                                    <?php $__currentLoopData = $productDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <div class="d-table-tr" style="border-top:1px solid #000;">
                                                            <div class="d-table-td w-22">
                                                                <pre data-v-f2a183a6=""><?php echo e($item->sku); ?> ,  <?php echo e($item->name); ?></pre>
                                                                <p>
                                                                    <div class="row">
                                                                        <?php $__currentLoopData = $purchaseBarcode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php if($item->id == $code->product_id): ?>
                                                                                <div class="col-md-3" style="margin-bottom: 5px;">
                                                                                    <strong style="padding: 2px;
                                                                                    background: #e0d9d9;
                                                                                    margin-right: 5px; font-size:12px;"><?php echo e($code->barcode); ?></strong>
                                                                                </div>
                                                                            <?php endif; ?>
                                                            ...
                                                            <div class="d-table-td w-1">
                                                                <?php $stock = []; ?>
                                                                <?php $__currentLoopData = $purchaseBarcode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php if($item->id == $code->product_id): ?>
                                                                        <?php array_push($stock,$code->barcode); ?>
                                                                    <?php endif; ?>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                <pre data-v-f2a183a6=""><?php echo e(count($stock)); ?></pre>
                                                            </div>
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php else: ?>
...
<?php /**PATH /home/vsgpintl/admin.imontechnologies.in/resources/views/productservice/product_available_barcode.blade.php ENDPATH**/ ?>