                        ...
                        <div data-v-f2a183a6="" class="d" id="boxes" style="margin-left: auto;margin-right: auto;">
                            <div data-v-f2a183a6="" class="d-body">
                                <div data-v-f2a183a6="" class="d-bill-to">
                                    <div class="row">
                                        <h4 style="display:flex; width: 100%; justify-content: space-between;">
                                            <strong data-v-f2a183a6=""><?php echo e(__('Stock Summary Report')); ?></strong>
                                            <strong data-v-f2a183a6=""><?php echo e(__('Print Date')); ?>: <?php echo e(date('d/m/Y')); ?></strong>
                                        </h4>
                                    </div>
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                                <div class="d-table-th w-5"><?php echo e(__('Model No')); ?></div>
                                                <div class="d-table-th w-5"><?php echo e(__('Name')); ?></div>
                                                <div class="d-table-th w-5"><?php echo e(__('Description')); ?></div>
                                                <div class="d-table-th w-3"><?php echo e(__('Purchase')); ?></div>
                                                <div class="d-table-th w-3"><?php echo e(__('Sold')); ?></div>
                                                <div class="d-table-th w-2"><?php echo e(__('Stock')); ?></div>
                                            </div>

                                            <div class="d-table-body">
                                                <?php if(isset($productDetail) && count($productDetail) > 0): ?>
                                                <?php $__currentLoopData = $productDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6=""><?php echo e($item['sku'] != '' ? $item['sku'] : '-'); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6=""><?php echo e($item['name'] != '' ? $item['name'] : '-'); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6=""><?php echo e($item['description'] != null ? \Str::limit($item['description'],10)  : '-'); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-3">
                                                                <pre data-v-f2a183a6=""><?php echo e(isset($item['p_qty']) ? $item['p_qty'] : 0); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-3">
                                                                <pre data-v-f2a183a6=""><?php echo e(isset($item['s_qty']) ? $item['s_qty'] : 0); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-2">
                                                                <pre data-v-f2a183a6=""><?php echo e(isset($item['p_qty']) && isset($item['s_qty']) ? $item['p_qty'] - $item['s_qty'] : 0); ?></pre>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row justify-content mt-5">
                                        <div>
                                            <b>CREATED BY</b>
                                            <p><?php echo e(ucfirst($created_by['name'])); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php if(!isset($preview)): ?>
    <?php echo $__env->make('productservice.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
<?php endif; ?>
</body>
</html>
<?php /**PATH /home/vsgpintl/admin.imontechnologies.in/resources/views/productservice/product_available.blade.php ENDPATH**/ ?>