                        ...
                        <div data-v-f2a183a6="" class="d" id="boxes" style="margin-left: auto;margin-right: auto;">
                            <div data-v-f2a183a6="" class="d-body">
                                <div data-v-f2a183a6="" class="d-bill-to">
                                    <div class="row">
                                        <div class="bill_to">
                                            <strong data-v-f2a183a6=""><?php echo e(__('Purchase Return Record')); ?>:</strong>
                                            <table data-v-f2a183a6="" class="mt-5 summary-table">
                                                <tbody data-v-f2a183a6="">
                                                <tr>
                                                    <td><?php echo e(__('Number')); ?>:</td>
                                                    <td><?php echo e($purchase_number); ?></td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo e(__('Return Date')); ?>:</td>
                                                    <td><?php echo e(Utility::dateFormat($settings,$getReturnRecord[0]['return_date'])); ?></td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo e(__('Vendor')); ?>:</td>
                                                    <td><?php echo e($venders['name']); ?></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                                <div class="d-table-th w-4"><?php echo e(__('Unique Id')); ?></div>
                                                <div class="d-table-th w-4"><?php echo e(__('Purchase')); ?></div>
                                                <div class="d-table-th w-3"><?php echo e(__('Description')); ?></div>
                                                <div class="d-table-th w-4"><?php echo e(__('Price')); ?></div>
                                                <div class="d-table-th w-5"><?php echo e(__('Required')); ?></div>
                                                <div class="d-table-th w-4"><?php echo e(__('Returned')); ?></div>
                                            </div>

                                            <div class="d-table-body">
                                                <?php if(isset($getReturnRecord) && count($getReturnRecord) > 0): ?>
                                                    <?php $__currentLoopData = $getReturnRecord; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                            <div class="d-table-td w-4">
                                                                <pre data-v-f2a183a6=""><?php echo e($item->return_id); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-4">
                                                                <pre data-v-f2a183a6=""><?php echo e($item->name); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-3">
                                                                <pre data-v-f2a183a6=""><?php echo e($item->description != null ? $item->description  : '-'); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-4">
                                                                <pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$item->price)); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6=""><?php echo e($item->required_qty); ?></pre>
                                                            </div>

                                                            <div class="d-table-td w-4">
                                                                <pre data-v-f2a183a6=""><?php echo e($item->return_qty); ?></pre>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row justify-content" style="margin-top: 20px;">
                                        <div>
                                            <b>CREATED BY</b>
...
<?php /**PATH /home/vsgpintl/admin.imontechnologies.in/resources/views/purchase/pdf/purchase_return_temp.blade.php ENDPATH**/ ?>