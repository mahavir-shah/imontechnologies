...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                <?php echo e(Form::label('contact',__('Contact No'),['class'=>'form-label'])); ?>
...
<?php /**PATH /home/vsgpintl/admin.imontechnologies.in/resources/views/vender/create.blade.php ENDPATH**/ ?>