...
<?php $__env->startPush('script-page'); ?>
    <script>
        ...
        $(document).on('change', '.clientType', function () {
            var a = $('#dealer_category option:selected').val();
            $('.discount').val(a);
        })
    </script>
<?php $__env->stopPush(); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            <tr>
                                ...
                                <th> <?php echo e(__('Place Of Supply')); ?></th>
                                <th> <?php echo e(__('Receivables (BCY)')); ?></th>
                                <th> <?php echo e(__('Unused Credits (BCY)')); ?></th>
                            ...
                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="cust_tr" id="cust_detail" data-url="<?php echo e(route('customer.show',$customer['id'])); ?>" data-id="<?php echo e($customer['id']); ?>">
                                    ...
                                    <td><?php echo e((!empty($customer['shipping_city'])) ? $customer['shipping_city'] : '-'); ?></td>
                                    <td><?php echo e(\Auth::user()->priceFormat($customer['receivable'] )); ?></td>
                                    <td><?php echo e(\Auth::user()->priceFormat($customer['unused'])); ?></td>
                                    <td class="Action">
                                        <span>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/imontechnologies/resources/views/customer/index.blade.php ENDPATH**/ ?>