        ...
        <div class="col-9">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted mt-4"><strong><?php echo e(__('Note')); ?> : </strong><?php echo e(__('You can easily change order of job stage using drag & drop.')); ?></p>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/earthdlp/admin.imontechnologies.in/resources/views/jobStage/index.blade.php ENDPATH**/ ?>