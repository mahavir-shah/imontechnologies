    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('account_no',null,array('class'=>'form-control'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('ifsc_code',null,array('class'=>'form-control'))); ?>
...
<?php /**PATH /home/vsgpintl/admin.imontechnologies.in/resources/views/customer/create.blade.php ENDPATH**/ ?>