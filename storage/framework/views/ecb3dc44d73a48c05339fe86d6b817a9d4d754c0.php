...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            ...
            <?php echo e(Form::text('amount',$purchase->getDue(), array('class' => 'form-control','required'=>'required'))); ?>
        ...
        <div class="form-group  col-md-6">
            <?php echo e(Form::label('bill_no', __('Bill No'),['class'=>'form-label'])); ?>

            <?php echo e(Form::text('bill_no', '', array('class' => 'form-control'))); ?>
...
<?php /**PATH /var/www/html/imontechnologies/resources/views/purchase/payment.blade.php ENDPATH**/ ?>