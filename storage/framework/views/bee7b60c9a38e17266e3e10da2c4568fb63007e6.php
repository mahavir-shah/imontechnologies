                                ...
                                <table class="table ">
                                    ...
                                    <?php $__currentLoopData = $iteams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$iteam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td width="100px"><input type="number" name="carton" class="form-control carton"/>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </table>
                                <div class="float-right mb-3">
                                    <input value="<?php echo e($posShip->id); ?>" type="hidden" name="shipId" id="shipId"/>
                                    <button type="button" class="text-end btn btn-success btn-done-payment rounded me-2" id="packItem">
                                        <?php echo e(__('Pack')); ?>
...
<?php /**PATH /home1/earthdlp/admin.imontechnologies.in/resources/views/ship/packing.blade.php ENDPATH**/ ?>