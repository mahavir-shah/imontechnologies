...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create document type')): ?>
            <a href="#" data-url="<?php echo e(route('document.create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New Document Type')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>"  class="btn btn-sm btn-primary">
                                    ...
                                    <td>
                                        <h6 class="float-left mr-1">
                                            <?php if( $document->is_required == 1 ): ?>
                                                <div class="doc_status_badge badge bg-success p-2 px-3 rounded"><?php echo e(__('Required')); ?></div>
                                            <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/earthdlp/admin.imontechnologies.in/resources/views/document/index.blade.php ENDPATH**/ ?>