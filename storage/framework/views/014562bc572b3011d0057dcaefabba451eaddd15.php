        ...
        function changeItem(element) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('pos.returnItems')); ?>',
                        type: 'GET',
                        headers: {
                            'X-CSRF-TOKEN': jQuery('#token').val()
                        },
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <?php echo e(Form::model($pos, array('route' => array('pos.addPosReturn', $pos->id), 'method' => 'POST','class'=>'w-100'))); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('pos_number', __('Pos Number'),['class'=>'form-label'])); ?>
        ...
        <div class="col-12">
            <h5 class="d-inline-block mb-4"><?php echo e(__('Sales Return')); ?></h5>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/earthdlp/admin.imontechnologies.in/resources/views/pos/sales_return.blade.php ENDPATH**/ ?>