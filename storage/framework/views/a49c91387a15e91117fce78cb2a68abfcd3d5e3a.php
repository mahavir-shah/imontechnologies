<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Product Kit Create')); ?>
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Product Kit Create')); ?></li>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
<div class="row">
	<?php echo e(Form::open(array('url' => 'productkit','class'=>'w-100'))); ?>
					...
					<table class="table mb-0" data-repeater-list="items" id="sortable-table">
						...
						<tbody>
							<tr>
								...
								<td width="15%">
									<?php echo e(Form::text('cost_price[]','', array('class' => 'form-control cost_price','required'=>'required','placeholder'=>"",'required'=>'required','readonly'=>true ))); ?>
			...
			<div class="card-body row">
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="form-icon-user">
							<?php echo e(Form::text('total_alliance_purchase_price', '', array('class' => 'form-control total_alliance_purchase_price_input','required'=>'required'))); ?>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="form-icon-user">
							<?php echo e(Form::text('total_cost_price', '', array('class' => 'form-control total_cost_price_input','required'=>'required'))); ?>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="form-icon-user">
							<?php echo e(Form::text('total_premium_purchase_price', '', array('class' => 'form-control total_premium_purchase_price_input','required'=>'required'))); ?>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="form-icon-user">
							<?php echo e(Form::text('total_standard_purchase_price', '', array('class' => 'form-control total_standard_purchase_price_input','required'=>'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/imontechnologies/resources/views/productkit/create.blade.php ENDPATH**/ ?>