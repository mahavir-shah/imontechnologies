                        ...
                        <div data-v-f2a183a6="" class="d" id="boxes" style="margin-left: auto;margin-right: auto;">
                            <div data-v-f2a183a6="" class="d-body">
                                <div data-v-f2a183a6="" class="d-bill-to">
                                    <div class="row">
                                        <div class="bill_to">
                                            <strong data-v-f2a183a6=""><?php echo e(__('Purchase Goods Record')); ?>:</strong>
                                            <table data-v-f2a183a6="" class="mt-5 summary-table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo e(Utility::dateFormat($settings,$getGoodsRecord[0]['received_date'])); ?></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                                ...
                                                <div class="d-table-th w-4"><?php echo e(__('Committed')); ?></div>
                                            </div>

                                            <div class="d-table-body">
                                                <?php if(isset($getGoodsRecord) && count($getGoodsRecord) > 0): ?>
                                                    <?php $__currentLoopData = $getGoodsRecord; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                        <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                            <div class="d-table-td w-4">
                                                                <pre data-v-f2a183a6=""><?php echo e($item->goods_unique_id); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-4">
                                                            ...
                                                            <div class="d-table-td w-4">
                                                                <pre data-v-f2a183a6=""><?php echo e($item->receiving_qty); ?></pre>
                                                            </div>
                                                        </div>
...
<?php /**PATH /home/vsgpintl/admin.imontechnologies.in/resources/views/purchase/pdf/good_record_temp.blade.php ENDPATH**/ ?>