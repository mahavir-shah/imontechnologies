    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::number('hsn_code', '', array('class' => 'form-control','required'=>'required'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::number('low_stock_notification', '', array('class' => 'form-control','required'=>'required','step'=>'1'))); ?>
...
<?php /**PATH /var/www/html/imontechnologies/resources/views/productservice/create.blade.php ENDPATH**/ ?>