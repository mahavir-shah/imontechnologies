                                ...
                                <tr class="font-style">
                                    ...
                                    <td class="Action">
                                        <div class="action-btn bg-info ms-2">
                                            <a data-size="md" href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-url="<?php echo e(route('productstock.edit', $productService->id)); ?>" data-ajax-popup="#"  data-size="xl" data-bs-toggle="tooltip" title="<?php echo e(__('Update Quantity')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ds-store\resources\views/productstock/index.blade.php ENDPATH**/ ?>