    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('gst_number',null,array('class'=>'form-control'))); ?>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('pan_number',null,array('class'=>'form-control'))); ?>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                <?php echo e(Form::label('receivable',__('Receivable'),['class'=>'form-label'])); ?>

                <?php echo e(Form::number('receivable',null,array('class'=>'form-control'))); ?>

            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                <?php echo e(Form::label('unused',__('Unused'),['class'=>'form-label'])); ?>

                <?php echo e(Form::number('unused',null,array('class'=>'form-control'))); ?>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::select('dealer_category', $clientType, null, array('class' => 'form-control select clientType','required'=>'required'))); ?>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('discount',20,array('class'=>'form-control discount'))); ?>
...
<?php /**PATH /var/www/html/imontechnologies/resources/views/customer/create.blade.php ENDPATH**/ ?>