        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-1">
                    <?php $__currentLoopData = $getGoodId; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $goods): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="pt-4 pb-3">
                            <a href="<?php echo e(route('purchase.goods_record_single_pdf',['unique_id' => $goods->goods_unique_id,'id' => $goods->purchase_id])); ?>" target="_blank" class="btn btn-primary">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vsgpintl/admin.imontechnologies.in/resources/views/purchase/goods_record.blade.php ENDPATH**/ ?>