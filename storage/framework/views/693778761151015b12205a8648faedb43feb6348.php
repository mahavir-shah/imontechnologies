...
<div class="col-sm-12">
    ...
    <div class="row">
        <div class="<?php echo e((Auth::user()->type =='company' || Auth::user()->type =='customer') ? 'col-xl-6 col-lg-6 col-md-6' : 'col-xl-8 col-lg-8 col-md-8'); ?> col-sm-12">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vsgpintl/admin.imontechnologies.in/resources/views/dashboard/clientView.blade.php ENDPATH**/ ?>