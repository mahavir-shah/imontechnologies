...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(Auth::user()->purchaseNumberFormat($purchase->id)); ?></li>
<?php $__env->stopSection(); ?>
                        ...
                        <div class="invoice-print">
                            <div class="row invoice-title mt-2">
                                ...
                                <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                                    <h4 class="invoice-number"><?php echo e(Auth::user()->purchaseNumberFormat($purchase->id)); ?></h4>
                                </div>
                                <div class="col-12">
                                    <hr>
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vsgpintl/admin.imontechnologies.in/resources/views/purchase/view.blade.php ENDPATH**/ ?>