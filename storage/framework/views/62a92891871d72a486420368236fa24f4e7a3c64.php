                    ...
                    <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage purchase')): ?>
                        <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'purchase')?'active':''); ?>">
                            <a href="<?php echo e(route('purchase.index')); ?>" class="dash-link">
                                <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span class="dash-mtext"><?php echo e(__('Product Kit')); ?></span>
                            </a>
                        </li>
                    <?php endif; ?> -->
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage purchase')): ?>
...
<?php /**PATH C:\xampp\htdocs\ds-store\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>