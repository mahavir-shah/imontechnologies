...
<?php echo e(Form::model($client, array('route' => array('discount-master.update', $client->id), 'method' => 'PUT'))); ?>
...
<div class="modal-body">
    <div class="row">
        <div class="form-group">
            ...
            <?php echo e(Form::text('client_type', null, array('class' => 'form-control','placeholder'=>__('Enter Client Type'),'required'=>'required','disabled'))); ?>
...
<?php /**PATH /home1/earthdlp/admin.imontechnologies.in/resources/views/discountMaster/edit.blade.php ENDPATH**/ ?>