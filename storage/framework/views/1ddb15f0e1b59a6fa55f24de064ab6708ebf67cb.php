                        ...
                        success: function (data) {
                            ...
                            if (purchaseItems != null) {
                                ...
                                if(purchaseItems.totalReturnQty != undefined){
                                    ...
                                    $(el.parent().parent().parent().find('.returnedQty')).val(purchaseItems.canReturnQty);
                                    $(el.parent().parent().parent().find('.returningQty')).val(purchaseItems.canReturnQty);
                                }else{
                                    $(el.parent().parent().parent().find('.requiredQty')).val(purchaseItems.quantity);
                                    $(el.parent().parent().parent().find('.returnedQty')).val(purchaseItems.canReturnQty);
                                    $(el.parent().parent().parent().find('.returningQty')).val(purchaseItems.canReturnQty);
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/imontechnologies/resources/views/purchase/purchase_return.blade.php ENDPATH**/ ?>