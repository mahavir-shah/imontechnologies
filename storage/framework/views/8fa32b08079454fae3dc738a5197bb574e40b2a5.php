        ...
        <div class="navbar-content">
            <?php if(\Auth::user()->type != 'customer'): ?>
                <ul class="dash-navbar">
                    ...
                    <?php if( Gate::check('manage customer') || Gate::check('manage vender') || Gate::check('manage customer') || Gate::check('manage vender') ||  Gate::check('manage bank account') ||  Gate::check('manage bank transfer') ||  Gate::check('manage invoice')
                          ...
                          || Gate::check('ledger report') ||  Gate::check('trial balance report')  ): ?>
                            <li class="dash-item dash-hasmenu
                                        <?php echo e((Request::route()->getName() == 'print-setting' || Request::segment(1) == 'customer' ||
                                            Request::segment(1) == 'vender' || Request::segment(1) == 'bank-account' ||
                        ...
                        <li class="dash-item dash-hasmenu">
                            ...
                            <ul class="dash-submenu">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage client')): ?>
                                    ...
                                    <li class="dash-item <?php echo e((Request::route()->getName() == 'discount-master.index' || Request::segment(1) == 'discount-master' || Request::route()->getName() == 'discount-master.edit') ? ' active' : ''); ?>">
                                        <a class="dash-link" href="<?php echo e(route('discount-master.index')); ?>"><?php echo e(__('Discount Master')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                        ...
                        <li class="dash-item dash-hasmenu">
                            ...
                            <ul class="dash-submenu">
                                <?php if(Gate::check('manage product & service')): ?>
                                    ...
                                    <li class="dash-item <?php echo e((Request::segment(1) == 'productprice')?'active':''); ?>">
                                        <a href="<?php echo e(route('productprice.index')); ?>" class="dash-link"><?php echo e(__('Product Selling Price')); ?>

                                        </a>
                                    </li>
                                    <li class="dash-item <?php echo e((Request::segment(1) == 'productkit')?'active':''); ?>">
                                        <a href="<?php echo e(route('productkit.index')); ?>" class="dash-link"><?php echo e(__('Product Kits/Combo')); ?>
                                ...
                                <?php if(Gate::check('manage product & service')): ?>
                                    ...
                                    <li class="dash-item <?php echo e((Request::segment(1) == 'stocktrack')?'active':''); ?>">
                                        <a href="<?php echo e(route('stocktrack.index')); ?>" class="dash-link"><?php echo e(__('Stock Tracking')); ?>
                    ...
                    <!--------------------- End Products System ----------------------------------->
					  ...
					  <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'estimate' || 
                            Request::route()->getName() == 'order.index' || 
                            Request::route()->getName() == 'invoice.index' || 
                            Request::route()->getName() == 'ship.pending' ||
                            Request::route()->getName() == 'customer.index' ||
                            Request::route()->getName() == 'productprice.index' ||
                            Request::route()->getName() == 'payment.index'
                            ) ? 'active dash-trigger' : ''); ?>">
                        <a href="#!" class="dash-link"><span class="dash-micon"><i class="ti ti-layers-difference"></i></span><span class="dash-mtext"><?php echo e(__('Sales')); ?></span><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu <?php echo e((Request::segment(1) == 'estimate' || 
                            Request::route()->getName() == 'order.index' || 
                            Request::route()->getName() == 'invoice.index' || 
                            Request::route()->getName() == 'ship.pending' ||
                            Request::route()->getName() == 'customer.index' ||
                            ...
                            <li class="dash-item <?php echo e((Request::segment(1) == 'estimate')?'active':''); ?>">
                                <a class="dash-link" href="<?php echo e(route('estimate.index')); ?>"><?php echo e(__('Estimate')); ?></a>
                            </li>
                            ...
                            <li class="dash-item <?php echo e((Request::route()->getName() == 'ship.pending' ) ? ' active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('ship.pending')); ?>"><?php echo e(__('Pick Pack Ship')); ?></a>
                            </li>
                            <li class="dash-item <?php echo e((Request::route()->getName() == 'invoice.index' || Request::route()->getName() == 'invoice.create' || Request::route()->getName() == 'invoice.edit' || Request::route()->getName() == 'invoice.show') ? ' active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('invoice.index')); ?>"><?php echo e(__('Invoice')); ?></a>
                            </li>
                            <li class="dash-item <?php echo e((Request::segment(1) == 'productprice')?'active':''); ?>">
                                <a href="<?php echo e(route('productprice.index')); ?>" class="dash-link"><?php echo e(__('Price List')); ?>
							...
							<li class="dash-item <?php echo e((Request::route()->getName() == 'termscondition.index') ? ' active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('termscondition.index')); ?>"><?php echo e(__('Terms Condition')); ?></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <?php if( Gate::check('manage warehouse') || Gate::check('manage pos') || Gate::check('manage print settings')): ?>
                        <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'warehouse' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' )?' active dash-trigger':''); ?>">
                            <a href="#!" class="dash-link"><span class="dash-micon"><i class="ti ti-layers-difference"></i></span><span class="dash-mtext"><?php echo e(__('Order')); ?></span><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                            <ul class="dash-submenu <?php echo e((Request::segment(1) == 'warehouse' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print')?'show':''); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage pos')): ?>
                                            ...
                                            <li class="dash-item <?php echo e((Request::route()->getName() == 'pos.report' ) ? ' active' : ''); ?>">
                                                <a class="dash-link" href="<?php echo e(route('pos.report')); ?>"><?php echo e(__('Sales')); ?></a>
                                            </li>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage purchase')): ?>
                        <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'purchase')?'active':''); ?>">
                            <a href="<?php echo e(route('purchase.index')); ?>" class="dash-link">
                                <span class="dash-micon"><i class="ti ti-archive"></i></span><span class="dash-mtext"><?php echo e(__('Purchase')); ?></span>
                            </a>
                        </li>
                    <?php endif; ?>
                    <!--------------------- End POs System ----------------------------------->
                    ...
                    <?php if( Gate::check('manage warehouse') || Gate::check('manage pos') || Gate::check('manage print settings')): ?>
                    <li class="dash-item dash-hasmenu <?php echo e((Request::route()->getName() == 'repair.repairIn' || Request::route()->getName() == 'repair.repairOut' )?' active dash-trigger':''); ?>">
                        <a href="#!" class="dash-link"><span class="dash-micon"><i class="ti ti-layers-difference"></i></span><span class="dash-mtext"><?php echo e(__('Repair')); ?></span><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu <?php echo e((Request::route()->getName() == 'repair.repairIn' || Request::route()->getName() == 'repair.repairOut')?'show':''); ?>">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage pos')): ?>
                                <li class="dash-item <?php echo e((Request::route()->getName() == 'repair.repairIn' ) ? ' active' : ''); ?>">
                                    <a class="dash-link" href="<?php echo e(route('repair.repairIn')); ?>"><?php echo e(__('Repair In')); ?></a>
                                </li>

                                <li class="dash-item <?php echo e((Request::route()->getName() == 'repair.repairOut' ) ? ' active' : ''); ?>">
                                    <a class="dash-link" href="<?php echo e(route('repair.repairOut')); ?>"><?php echo e(__('Repair Out')); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                            ...
                            <ul class="dash-submenu <?php echo e((Request::segment(1) == 'warehouse' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print')?'show':''); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage pos')): ?>
                                            <li class="dash-item <?php echo e((Request::route()->getName() == 'pos.index' ) ? ' active' : ''); ?>">
                                                <a class="dash-link" href="<?php echo e(route('pos.index')); ?>"><?php echo e(__(' Add Sales')); ?></a>
                                            </li>
...
<?php /**PATH /var/www/html/imontechnologies/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>