<?php echo e(Form::open(array('route' => array('pos.payment', $pos->id),'method'=>'post','enctype' => 'multipart/form-data'))); ?>
...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            ...
            <?php echo e(Form::text('amount',$pos->getDue(), array('class' => 'form-control','required'=>'required'))); ?>
...
<?php /**PATH /home/hp/Documents/CNS/idea/resources/views/pos/payment.blade.php ENDPATH**/ ?>