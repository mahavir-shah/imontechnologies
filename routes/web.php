...
Route::get('productservice/costMargin/{id}', 'ProductServiceController@costMargin')->name('productservice.costMargin');
Route::put('productservice/updateCostMargin/{id}', 'ProductServiceController@updateCostMargin')->name('productservice.updateCostMargin');
Route::get('productprice/index', 'ProductServiceController@productPrice')->name('productprice.index');
...
Route::post('products/filterData', 'ProductServiceController@filterData')->name('products.filterData')->middleware(
    [
        'XSS',
        'revalidate',
    ]
);
Route::get('products/availableProduct', 'ProductServiceController@availableProduct')->name('products.availableProduct');
...
Route::get('stocktrack', 'ProductServiceController@stocktrack')->name('stocktrack.index');
...
Route::get('estimate/pdf/{id}', 'ProposalController@proposal')->name('proposal.pdf')->middleware(
    [
        'XSS',
        'revalidate',
    ]
...
Route::group(
    ...
    Route::get('estimate/{id}/status/change', 'ProposalController@statusChange')->name('proposal.status.change');
    Route::get('estimate/{id}/convert', 'ProposalController@convert')->name('proposal.convert');
    ...
    Route::get('estimate/{id}/resent', 'ProposalController@resent')->name('proposal.resent');

    Route::resource('estimate', 'ProposalController');
    Route::get('estimate/create/{cid}', 'ProposalController@create')->name('proposal.create');
}
);

Route::get(
    '/estimate/preview/{template}/{color}', [
                                              'as' => 'proposal.preview',
                                              'uses' => 'ProposalController@previewProposal',
                                          ]
);
Route::post(
    '/estimate/template/setting', [
...
//Discount master
Route::resource('discount-master', 'DiscountMasterController')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('/customer/estimate/{id}/', 'ProposalController@invoiceLink')->name('proposal.link.copy')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::get('export/estimate', 'ProposalController@export')->name('proposal.export');
...
Route::group(
    ...
    Route::get('purchase/goodsFilter', 'PurchaseController@goodsRecordsFilter')->name('purchase.goodsFilter');
    Route::get('purchase/returnFilter', 'PurchaseController@returnRecordsFilter')->name('purchase.returnFilter');
    Route::get('purchase/items', 'PurchaseController@items')->name('purchase.items');
    Route::get('purchase/returnItems', 'PurchaseController@returnItems')->name('purchase.returnItems');
    //pos items ajax
    Route::get('pos/items', 'PosController@items')->name('pos.items');
    Route::get('pos/returnFilter', 'PosController@returnRecordsFilter')->name('pos.returnFilter');
    Route::get('pos/returnItems', 'PosController@returnItems')->name('pos.returnItems');
...
//    Route::get('/bill/{id}/', 'PurchaseController@purchaseLink')->name('purchase.link.copy');
    ...
    Route::get('purchase/goods-received/{id}', 'PurchaseController@goodsReceived')->name('purchase.goods-received');
    Route::post('purchase/addGoodReceived/{id}', 'PurchaseController@addGoodReceived')->name('purchase.addGoodReceived');
    Route::get('purchase/goods-records/{id}', 'PurchaseController@goodsRecords')->name('purchase.goods-records');

    Route::get('purchase/purchase-return/{id}', 'PurchaseController@purchaseReturn')->name('purchase.purchase-return');
    Route::post('purchase/addPurchaseReturn/{id}', 'PurchaseController@addPurchaseReturn')->name('purchase.addPurchaseReturn');
    Route::get('purchase/return-records/{id}', 'PurchaseController@returnRecords')->name('purchase.return-records');
}
...
Route::get('purchase/goods_record_pdf/{id}', 'PurchaseController@goodsRecordPdf')->name('purchase.goods_record_pdf')->middleware(
    [
        'XSS',
        'revalidate',
    ]
);
Route::get('purchase/goods_record_single_pdf/{unique_id}/{id}', 'PurchaseController@goodsRecordSinglePdf')->name('purchase.goods_record_single_pdf')->middleware(
    [
        'XSS',
        'revalidate',
    ]
);
Route::get('purchase/purchase_return_single_pdf/{unique_id}/{id}', 'PurchaseController@purchaseRecordSinglePdf')->name('purchase.purchase_return_single_pdf')->middleware(
    [
        'XSS',
        'revalidate',
    ]
);
Route::get('purchase/purchase_return_pdf/{id}', 'PurchaseController@purchaseReturnPdf')->name('purchase.purchase_return_pdf')->middleware(
    [
        'XSS',
        'revalidate',
    ]
);
Route::get('pos/pdf/{id}', 'PosController@posPdf')->name('pos.pdf')->middleware(
    [
        'XSS',
        'revalidate',
    ]
);
Route::get('pos/pos_return_pdf/{id}', 'PosController@posReturnPdf')->name('pos.pos_return_pdf')->middleware(
    [
        'XSS',
        'revalidate',
    ]
);
Route::get('pos/pos_return_single_pdf/{unique_id}/{id}', 'PosController@posReturnSinglePdf')->name('pos.pos_return_single_pdf')->middleware(
    [
        'XSS',
        'revalidate',
    ]
);
Route::get('pos/ship_pdf/{id}', 'PosController@posShipPdf')->name('pos.ship_pdf')->middleware(
    [
        'XSS',
        'revalidate',
    ]
...
Route::get('pos/get_invoice/{id}', 'PosController@showPosInvoice')->name('pos.get_invoice')->middleware(['auth', 'XSS']);
Route::get('pos/sales_approve/{id}', 'PosController@posSalesApprove')->name('pos.sales_approve')->middleware(['auth', 'XSS']);
Route::get('pos/sales_cancel/{id}', 'PosController@posSalesCancel')->name('pos.sales_cancel')->middleware(['auth', 'XSS']);
Route::get('pos/show_approve_detail/{id}', 'PosController@showApproveDetail')->name('pos.show_approve_detail')->middleware(['auth', 'XSS']);
Route::get('pos/sales_edit/{id}', 'PosController@edit')->name('pos.sales_edit')->middleware(['auth', 'XSS']);
Route::get('pos/{id}/payment', 'PosController@payment')->name('pos.payment');
Route::post('pos/{id}/payment', 'PosController@createPayment')->name('pos.payment');

Route::get('pos/pos-return/{id}', 'PosController@posReturn')->name('pos.pos-return');
Route::post('pos/addPosReturn/{id}', 'PosController@addPosReturn')->name('pos.addPosReturn');
Route::get('pos/return-records/{id}', 'PosController@returnRecords')->name('pos.return-records');
Route::post('pickpack/pending_pick', 'ShippingController@index')->name('pickpack.pending_pick');

//Pick-pack-ship
Route::get('ship/pending', 'ShippingController@pendingList')->name('ship.pending')->middleware(['auth', 'XSS']);
Route::delete('ship/cancelShip/{id}', 'ShippingController@shipCancel')->name('ship.cancelShip')->middleware(['auth', 'XSS']);
Route::get('ship/showPicking/{id}', 'ShippingController@showPicking')->name('ship.showPicking')->middleware(['auth', 'XSS']);
Route::get('ship/addPicking/{id}', 'ShippingController@addPicking')->name('ship.addPicking')->middleware(['auth', 'XSS']);
Route::get('ship/showPacking/{id}', 'ShippingController@showPacking')->name('ship.showPacking')->middleware(['auth', 'XSS']);
Route::get('ship/addPacking/{id?}', 'ShippingController@addPacking')->name('ship.addPacking')->middleware(['auth', 'XSS']);
Route::post('ship/addPackingDetail', 'ShippingController@addPackingDetail')->name('ship.addPackingDetail');
Route::post('ship/cancelPacking/{id?}', 'ShippingController@cancelPacking')->name('ship.cancelPacking');
Route::post('ship/savePacking', 'ShippingController@savePacking')->name('ship.savePacking');
Route::post('ship/addPickingData/{id?}', 'ShippingController@addPickingData')->name('ship.addPickingData');
Route::get('ship/checkBarcode', 'ShippingController@checkBarcode')->name('ship.checkBarcode')->middleware(['auth', 'XSS']);
Route::post('ship/addShipForm', 'ShippingController@addShipForm')->name('ship.addShipForm')->middleware(['auth', 'XSS']);
Route::get('ship/showShipForm/{id}', 'ShippingController@showShipForm')->name('ship.showShipForm')->middleware(['auth', 'XSS']);

//Product Kit
Route::resource('productkit', 'ProductKitController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
//Repair module
Route::get('repair/repairIn', 'RepairController@repairIn')->name('repair.repairIn')->middleware(['auth', 'XSS']);
Route::get('repair/repairOut', 'RepairController@repairOut')->name('repair.repairOut')->middleware(['auth', 'XSS']);
...
Route::get('setting/getBarcodePrint', 'PosController@getBarcodePrint')->name('pos.getBarcodePrint')->middleware(['auth', 'XSS']);
Route::post('setting/findBarcode', 'PosController@findBarcode')->name('pos.findBarcode')->middleware(['auth', 'XSS']);
Route::post('barcode/settings', 'PosController@BarcodesettingStore')->name('barcode.setting');
Route::get('print/pos/{id?}', 'PosController@printBarcode')->name('pos.print')->middleware(['auth', 'XSS']);
