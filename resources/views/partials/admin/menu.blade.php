        ...
        <div class="navbar-content">
            @if(\Auth::user()->type != 'customer')
                <ul class="dash-navbar">
                    ...
                    @if( Gate::check('manage customer') || Gate::check('manage vender') || Gate::check('manage customer') || Gate::check('manage vender') ||  Gate::check('manage bank account') ||  Gate::check('manage bank transfer') ||  Gate::check('manage invoice')
                        ...
                        <li class="dash-item dash-hasmenu">
                            ...
                            <ul class="dash-submenu">
                                ...
                                @can('manage client')
                                    ...
                                    <li class="dash-item {{ (Request::route()->getName() == 'discount-master.index' || Request::segment(1) == 'discount-master' || Request::route()->getName() == 'discount-master.edit') ? ' active' : '' }}">
                                        <a class="dash-link" href="{{ route('discount-master.index') }}">{{__('Discount Master')}}</a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                            ...
                            <ul class="dash-submenu">
                                @if(Gate::check('manage product & service'))
                                    <li class="dash-item {{ (Request::segment(1) == 'productservice')?'active':''}}">
                                        <a href="{{ route('productservice.index') }}" class="dash-link">{{__('Products')}}
                                        </a>
                                    </li>
                                    <li class="dash-item {{ (Request::segment(1) == 'productprice')?'active':''}}">
                                        <a href="{{ route('productprice.index') }}" class="dash-link">{{__('Product Selling Price')}}
                                        </a>
                                    </li>
                                    <li class="dash-item {{ (Request::segment(1) == 'productkit')?'active':''}}">
                                        <a href="{{ route('productkit.index') }}" class="dash-link">{{__('Product Kits/Combo')}}
                                        </a>
                                    </li>
                                @endif
                                @if(Gate::check('manage product & service'))
                                    ...
                                    <li class="dash-item {{ (Request::segment(1) == 'stocktrack')?'active':''}}">
                                        <a href="{{ route('stocktrack.index') }}" class="dash-link">{{__('Stock Tracking')}}
                                        </a>
                                    </li>
                                @endif
                            </ul>
                    ...
                    <!--------------------- End Products System ----------------------------------->
					  ...
					  <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'estimate' || 
                        ...
                        <a href="#!" class="dash-link"><span class="dash-micon"><i class="ti ti-layers-difference"></i></span><span class="dash-mtext">{{__('Sales')}}</span><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu {{ (Request::segment(1) == 'estimate' || 
                            Request::route()->getName() == 'order.index' || 
                            Request::route()->getName() == 'invoice.index' || 
                            Request::route()->getName() == 'ship.pending' ||
                            Request::route()->getName() == 'customer.index' ||
                            ...
                            <li class="dash-item {{ (Request::segment(1) == 'estimate')?'active':''}}">
                            ...
                            <li class="dash-item {{ (Request::route()->getName() == 'ship.pending' ) ? ' active' : '' }}">
                                <a class="dash-link" href="{{ route('ship.pending') }}">{{__('Pick Pack Ship')}}</a>
                            </li>
                            <li class="dash-item {{ (Request::route()->getName() == 'invoice.index' || Request::route()->getName() == 'invoice.create' || Request::route()->getName() == 'invoice.edit' || Request::route()->getName() == 'invoice.show') ? ' active' : '' }}">
                                <a class="dash-link" href="{{ route('invoice.index') }}">{{__('Invoice')}}</a>
                            </li>
                            <li class="dash-item {{ (Request::segment(1) == 'productprice')?'active':''}}">
                                <a href="{{ route('productprice.index') }}" class="dash-link">{{__('Price List')}}
                                </a>
                            </li>
                            <li class="dash-item {{ (Request::route()->getName() == 'payment.index' || Request::route()->getName() == 'payment.create' || Request::route()->getName() == 'payment.edit') ? ' active' : '' }}">
                                <a class="dash-link" href="{{route('payment.index')}}">{{__('Payment')}}</a>
                            </li>
							<li class="dash-item {{ (Request::route()->getName() == 'termscondition.index') ? ' active' : '' }}">
                                <a class="dash-link" href="{{route('termscondition.index')}}">{{__('Terms Condition')}}</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    @if( Gate::check('manage warehouse') || Gate::check('manage pos') || Gate::check('manage print settings'))
                        <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'warehouse' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' )?' active dash-trigger':''}}">
                            <a href="#!" class="dash-link"><span class="dash-micon"><i class="ti ti-layers-difference"></i></span><span class="dash-mtext">{{__('Order')}}</span><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                            <ul class="dash-submenu {{ (Request::segment(1) == 'warehouse' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print')?'show':''}}">
                    ...
                    @endif
                    @can('manage purchase')
                        <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'purchase')?'active':''}}">
                            <a href="{{route('purchase.index')}}" class="dash-link">
                                <span class="dash-micon"><i class="ti ti-archive"></i></span><span class="dash-mtext">{{__('Purchase')}}</span>
                            </a>
                        </li>
                    @endcan
                    <!--------------------- End POs System ----------------------------------->
                    ...
                    @if( Gate::check('manage warehouse') || Gate::check('manage pos') || Gate::check('manage print settings'))
                    <li class="dash-item dash-hasmenu {{ (Request::route()->getName() == 'repair.repairIn' || Request::route()->getName() == 'repair.repairOut' )?' active dash-trigger':''}}">
                        <a href="#!" class="dash-link"><span class="dash-micon"><i class="ti ti-layers-difference"></i></span><span class="dash-mtext">{{__('Repair')}}</span><span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu {{ (Request::route()->getName() == 'repair.repairIn' || Request::route()->getName() == 'repair.repairOut')?'show':''}}">
                            @can('manage pos')
                                <li class="dash-item {{ (Request::route()->getName() == 'repair.repairIn' ) ? ' active' : '' }}">
                                    <a class="dash-link" href="{{ route('repair.repairIn') }}">{{__('Repair In')}}</a>
                                </li>

                                <li class="dash-item {{ (Request::route()->getName() == 'repair.repairOut' ) ? ' active' : '' }}">
                                    <a class="dash-link" href="{{ route('repair.repairOut') }}">{{__('Repair Out')}}</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                    ...
                    @if( Gate::check('manage warehouse') || Gate::check('manage pos') || Gate::check('manage print settings'))
                        <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'warehouse' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' )?' active dash-trigger':''}}">
                            ...
                            <ul class="dash-submenu {{ (Request::segment(1) == 'warehouse' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print')?'show':''}}">
                                ...
                                @can('manage pos')
                                            <li class="dash-item {{ (Request::route()->getName() == 'pos.index' ) ? ' active' : '' }}">
                                                <a class="dash-link" href="{{ route('pos.index') }}">{{__(' Add Sales')}}</a>
                                            </li>
