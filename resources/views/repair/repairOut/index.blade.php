                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($productServices as $productService)
                                <tr class="font-style">
                                    ...
                                    <td>{{ $productService->product_type == 'barcode' ? 'Barcoded' : 'Non-Barcoded'}}</td>
                                        ...
                                        <td class="Action">
                                            ...
                                            @can('edit product & service')
                                                ...
                                                <div class="action-btn bg-purple-400 ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm  align-items-center" data-url="{{ route('productservice.costMargin',$productService->id) }}" data-ajax-popup="true"  data-size="md" data-bs-toggle="tooltip" title="{{__('Cost')}}"  data-title="{{__('Cost')}}">
