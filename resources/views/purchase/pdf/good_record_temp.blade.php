                        ...
                        <div data-v-f2a183a6="" class="d" id="boxes" style="margin-left: auto;margin-right: auto;">
                            <div data-v-f2a183a6="" class="d-body">
                                <div data-v-f2a183a6="" class="d-bill-to">
                                    <div class="row">
                                        <div class="bill_to">
                                            <strong data-v-f2a183a6="">{{__('Purchase Goods Record')}}:</strong>
                                            <table data-v-f2a183a6="" class="mt-5 summary-table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{Utility::dateFormat($settings,$getGoodsRecord[0]['received_date'])}}</td>
                                                </tr>
                                                <tr>
                                                    <td>{{__('Vendor')}}:</td>
                                                    <td>{{$venders['name']}}</td>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: {{$color}};color:{{$font_color}}">
                                                ...
                                                <div class="d-table-th w-4">{{__('Committed')}}</div>
                                            </div>

                                            <div class="d-table-body">
                                                @if(isset($getGoodsRecord) && count($getGoodsRecord) > 0)
                                                    @foreach($getGoodsRecord as $key => $item)

                                                        <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                                            <div class="d-table-td w-4">
                                                                <pre data-v-f2a183a6="">{{$item->goods_unique_id}}</pre>
                                                            </div>
                                                            <div class="d-table-td w-4">
                                                            ...
                                                            <div class="d-table-td w-4">
                                                                <pre data-v-f2a183a6="">{{$item->receiving_qty}}</pre>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
