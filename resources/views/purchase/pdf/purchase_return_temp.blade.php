                        ...
                        <div data-v-f2a183a6="" class="d" id="boxes" style="margin-left: auto;margin-right: auto;">
                            <div data-v-f2a183a6="" class="d-body">
                                <div data-v-f2a183a6="" class="d-bill-to">
                                    <div class="row">
                                        <div class="bill_to">
                                            <strong data-v-f2a183a6="">{{__('Purchase Return Record')}}:</strong>
                                            <table data-v-f2a183a6="" class="mt-5 summary-table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{Utility::dateFormat($settings,$getReturnRecord[0]['return_date'])}}</td>
                                                </tr>
                                                <tr>
                                                    <td>{{__('Vendor')}}:</td>
                                                    <td>{{$venders['name']}}</td>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: {{$color}};color:{{$font_color}}">
                                                <div class="d-table-th w-4">{{__('Unique Id')}}</div>
                                                <div class="d-table-th w-4">{{__('Purchase')}}</div>
                                                <div class="d-table-th w-3">{{__('Description')}}</div>
                                                <div class="d-table-th w-4">{{__('Price')}}</div>
                                                <div class="d-table-th w-5">{{__('Required')}}</div>
                                                <div class="d-table-th w-4">{{__('Returned')}}</div>
                                            </div>

                                            <div class="d-table-body">
                                                @if(isset($getReturnRecord) && count($getReturnRecord) > 0)
                                                    @foreach($getReturnRecord as $key => $item)
                                                        <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                                            <div class="d-table-td w-4">
                                                                <pre data-v-f2a183a6="">{{$item->return_id}}</pre>
                                                            </div>
                                                            <div class="d-table-td w-4">
                                                                <pre data-v-f2a183a6="">{{$item->name}}</pre>
                                                            </div>
                                                            <div class="d-table-td w-3">
                                                                <pre data-v-f2a183a6="">{{$item->description != null ? $item->description  : '-'}}</pre>
                                                            </div>
                                                            <div class="d-table-td w-4">
                                                                <pre data-v-f2a183a6="">{{Utility::priceFormat($settings,$item->price)}}</pre>
                                                            </div>
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6="">{{$item->required_qty}}</pre>
                                                            </div>

                                                            <div class="d-table-td w-4">
                                                                <pre data-v-f2a183a6="">{{$item->return_qty}}</pre>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
