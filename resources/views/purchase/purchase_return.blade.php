        ...
        function changeItem(element) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        url: '{{route('purchase.returnItems')}}',
                        type: 'GET',
                        headers: {
                            'X-CSRF-TOKEN': jQuery('#token').val()
                        },
...
@section('content')
    <div class="row">
        ...
        {{ Form::model($purchase, array('route' => array('purchase.addPurchaseReturn', $purchase->id), 'method' => 'POST','class'=>'w-100')) }}
        <div class="col-12">
        ...
        <div class="col-12">
            <h5 class="d-inline-block mb-4">{{__('Purchase Return')}}</h5>
