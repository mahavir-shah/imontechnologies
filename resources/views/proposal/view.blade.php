...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Estimate Details')}}</li>
                        ...
                        <div class="card-body">
                            <div class="row timeline-wrapper">
                                <div class="col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <h6 class="text-primary my-3">{{__('Create Estimate')}}</h6>
                                    <p class="text-muted text-sm mb-3"><i class="ti ti-clock mr-2"></i>{{__('Created on ')}}{{\Auth::user()->dateFormat($proposal->issue_date)}}</p>
                                    @can('edit proposal')
                                        <a href="{{ route('estimate.edit',\Crypt::encrypt($proposal->id)) }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="ti ti-pencil mr-2"></i>{{__('Edit')}}</a>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <h6 class="text-warning my-3">{{__('Send Estimate')}}</h6>
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <h6 class="text-info my-3">{{__('Estimate Status')}}</h6>
                                    <small>
                                        @if($proposal->status == 0)
                            ...
                            <div class="row">
                                <div class="col text-end">
                                    <div class="d-flex align-items-center justify-content-end">
                                        <div class="me-4">
                                            <small>
                                                <strong>{{__('Estimate Date')}} :</strong><br>
