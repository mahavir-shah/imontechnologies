...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Product Kit Edit')}}</li>
@endsection
...
@section('content')
<div class="row">
	{{ Form::open(array('route' => array('productkit.update', $productKit->id), 'method' => 'PUT','class'=>'w-100')) }}
	<div class="col-12">
        <div class="card">
			<div class="card-body">
				<div class="row">
					<div class="col-md-6 ">
						<div class="form-group">
							...
							<div class="form-icon-user">
								{{ Form::text('kit_name', $productKit->kit_name, array('class' => 'form-control','required'=>'required')) }}
							</div>
						</div>
					</div> 
				</div>
					...
					<table class="table mb-0" data-repeater-list="items" id="sortable-table">
						...
						<tbody>
							...
							@foreach($product_info as $pi)
								<tr>
									...
									<td width="30%">
										{{ Form::select('product_id[]', $products,$pi['product_id'], 
											array(
									...
									<td>
										{{ Form::text('quantity[]',$pi['quantity'], array('class' => 'form-control quantity','required'=>'required','placeholder'=>__('Qty'),'required'=>'required')) }}                    
									</td>
									<td>
										@php
										...
										@endphp
										{{ Form::text('alliance_selling_price[]',$AllianceSellingPrice, array('class' => 'form-control alliance_selling_price','required'=>'required','placeholder'=>"",'required'=>'required' )) }}
									</td>
									<td>
										@php
										...
										@endphp
										{{ Form::text('premium_selling_price[]',$PremiumSellingPrice, array('class' => 'form-control premium_selling_price','required'=>'required','placeholder'=>"",'required'=>'required' )) }}
									</td>
									<td>
										@php
										...
										@endphp
										{{ Form::text('standard_selling_price[]',$StandardSellingPrice, array('class' => 'form-control standard_selling_price','required'=>'required','placeholder'=>"",'required'=>'required')) }}
									</td>
									<td>
										@php
										...
										@endphp
										{{ Form::text('cost_price[]',$CostPrice, array('class' => 'form-control cost_price','required'=>'required','placeholder'=>"",'required'=>'required','readonly'=>true )) }}
									</td>
									<td>
									@if($i != 0)
						...
						<tfoot>
							<tr>
								...
								<td class="total_alliance_selling_price">{{ number_format($totalAllianceSellingPrice,2) }}</td>
								<td class="total_premium_selling_price">{{ number_format($totalPremiumSellingPrice,2) }}</td>
								<td class="total_standard_selling_price">{{ number_format($totalStandardSellingPrice,2) }}</td>
								<td class="total_cost_price">{{  number_format($totalCostPrice,2) }}</td>
							</tr>
						</tfoot>
					</table>
				</div>
			...
			<div class="card-body row">
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="form-icon-user">
							{{ Form::text('total_alliance_purchase_price', $productKit->total_alliance_purchase_price, array('class' => 'form-control total_alliance_purchase_price_input','required'=>'required')) }}
						</div>
					</div>
				</div>
				<div class="col-md-2">					
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="form-icon-user">
							{{ Form::text('total_cost_price', $productKit->total_cost_price, array('class' => 'form-control total_cost_price_input','required'=>'required')) }}
						</div>
					</div>
				</div>
				<div class="col-md-2">					
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="form-icon-user">
							{{ Form::text('total_premium_purchase_price', $productKit->total_premium_purchase_price, array('class' => 'form-control total_premium_purchase_price_input','required'=>'required')) }}
						</div>
					</div>
				</div>
				<div class="col-md-2">					
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="form-icon-user">
							{{ Form::text('total_standard_purchase_price', $productKit->total_standard_purchase_price, array('class' => 'form-control total_standard_purchase_price_input','required'=>'required')) }}
						</div>
					</div>
				</div>
				<div class="col-md-2">					
...
<div id="add-product-code" class="d-none">
	<table>
		<tr>
			...
			<td>
				{{ Form::text('cost_price[]','', array('class' => 'form-control cost_price','required'=>'required','placeholder'=>"",'required'=>'required')) }}
			</td>
			<td>
				<a href="#" class="ti ti-trash text-white text-white repeater-action-btn bg-danger ms-2"></a>
            </td>
