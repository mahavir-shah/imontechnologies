                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: {{$color}};color:{{$font_color}}">
                                                <div class="d-table-th w-22">{{__('Product')}}</div>
                                                <div class="d-table-th w-1">{{__('Stock')}}</div>
                                            </div>
                                            ...
                                            <div class="d-table-body">
                                                @if(isset($productDetail) && count($productDetail) > 0)
                                                    @foreach($productDetail as $key => $item)
                                                        ...
                                                        <div class="d-table-tr" style="border-top:1px solid #000;">
                                                            <div class="d-table-td w-22">
                                                                <pre data-v-f2a183a6="">{{$item->sku}} ,  {{$item->name}}</pre>
                                                                <p>
                                                                    <div class="row">
                                                                        @foreach ($purchaseBarcode as $code)
                                                                            @if($item->id == $code->product_id)
                                                                                <div class="col-md-3" style="margin-bottom: 5px;">
                                                                                    <strong style="padding: 2px;
                                                                                    background: #e0d9d9;
                                                                                    margin-right: 5px; font-size:12px;">{{$code->barcode}}</strong>
                                                                                </div>
                                                                            @endif
                                                                        @endforeach
                                                                    </div>
                                                            ...
                                                            <div class="d-table-td w-1">
                                                                <?php $stock = []; ?>
                                                                @foreach ($purchaseBarcode as $key => $code)
                                                                    @if($item->id == $code->product_id)
                                                                        <?php array_push($stock,$code->barcode); ?>
                                                                    @endif
                                                                @endforeach
                                                                <pre data-v-f2a183a6="">{{ count($stock)}}</pre>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
