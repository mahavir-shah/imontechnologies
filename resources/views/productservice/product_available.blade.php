                                ...
                                <div data-v-f2a183a6="" class="d-bill-to">
                                    <div class="row">
                                        <h4 style="display:flex; width: 100%; justify-content: space-between;">
                                            <strong data-v-f2a183a6="">{{__('Stock Summary Report')}}</strong>
                                            <strong data-v-f2a183a6="">{{__('Print Date')}}: {{ date('d/m/Y')}}</strong>
                                        </h4>
                                    </div>
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: {{$color}};color:{{$font_color}}">
                                                <div class="d-table-th w-5">{{__('Model No')}}</div>
                                                <div class="d-table-th w-5">{{__('Name')}}</div>
                                                <div class="d-table-th w-5">{{__('Description')}}</div>
                                                <div class="d-table-th w-3">{{__('Purchase')}}</div>
                                                <div class="d-table-th w-3">{{__('Sold')}}</div>
                                                <div class="d-table-th w-2">{{__('Stock')}}</div>
                                            </div>
                                                ...
                                                @foreach($productDetail as $key => $item)
                                                        <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6="">{{$item['sku'] != '' ? $item['sku'] : '-'}}</pre>
                                                            </div>
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6="">{{$item['name'] != '' ? $item['name'] : '-'}}</pre>
                                                            </div>
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6="">{{$item['description'] != null ? \Str::limit($item['description'],10)  : '-'}}</pre>
                                                            </div>
                                                            <div class="d-table-td w-3">
                                                                <pre data-v-f2a183a6="">{{isset($item['p_qty']) ? $item['p_qty'] : 0}}</pre>
                                                            </div>
                                                            <div class="d-table-td w-3">
                                                                <pre data-v-f2a183a6="">{{isset($item['s_qty']) ? $item['s_qty'] : 0}}</pre>
                                                            </div>
                                                            <div class="d-table-td w-2">
                                                                <pre data-v-f2a183a6="">{{isset($item['p_qty']) && isset($item['s_qty']) ? $item['p_qty'] - $item['s_qty'] : 0}}</pre>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
