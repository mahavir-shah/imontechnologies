...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Sales Edit')}}</li>
@endsection
@push('script-page')
...
@section('content')
    {{--    @dd($pos)--}}
    <div class="row">
        {{ Form::model($pos, array('route' => array('pos.update', $pos->id), 'method' => 'PUT','class'=>'w-100')) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                ...
                                {{ Form::select('customer_id', $customers,null, array('class' => 'form-control select ','id'=>'customer','data-url'=>route('invoice.customer'),'required'=>'required','disabled')) }}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            {{Form::date('issue_date',$pos->created_at,array('class'=>'form-control','required'=>'required','disabled'))}}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('pos_number', __('Sale Number'),['class'=>'form-label']) }}
                                        <div class="form-icon-user">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{ Form::select('customer_limit',$customer_limit,null, array('class' => 'form-control select customer_limit','required'=>'required')) }}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        {{ Form::text('price',null, array('class' => 'form-control price','required'=>'required','placeholder'=>__('Price'),'required'=>'required','disabled')) }}
                                ...
                                <td>
                                    <div class="form-group">
                                        <div class="input-group colorpickerinput">
                                            ...
                                            {{ Form::hidden('finalTax','', array('class' => 'form-control totalTax')) }}
                                            {{ Form::hidden('finalTax','', array('class' => 'form-control totalTax')) }}
                                            {{ Form::hidden('finalAmt','', array('class' => 'form-control totalAmount')) }}
                                        </div>
                                    </div>
                                </td>
