    ...
    <div class="row justify-content-between align-items-center mb-3">
        <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
            ...
            <div class="all-button-box">
                <a href="{{ route('pos.pdf', Crypt::encrypt($pos->pos_id))}}" target="_blank" class="btn btn-sm btn-primary">
                    {{__('Download')}}
                </a>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="float-end mt-3">
                                        ...
                                        {!! DNS2D::getBarcodeHTML(route('purchase.link.copy',\Illuminate\Support\Facades\Crypt::encrypt($pos->pos_id)), "QRCODE",2,2) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                                    ...
                                    <div class="table-responsive mt-3">
                                        <table class="table ">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">{{\Auth::user()->priceFormat($pos->getSubTotal())}}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="5"></td>
                                                <td class="text-end"><b>{{__('Discount')}}</b></td>
                                                <td class="text-end">{{$posPayment->discount ? \Auth::user()->priceFormat($posPayment->discount) : 0}}</td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="blue-text text-end">{{\Auth::user()->priceFormat($pos->getTotal())}}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="5"></td>
                                                <td class="text-end"><b>{{__('Paid')}}</b></td>
                                                <td class="text-end">{{\Auth::user()->priceFormat(($pos->getTotal()-$pos->getDue()))}}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="5"></td>
