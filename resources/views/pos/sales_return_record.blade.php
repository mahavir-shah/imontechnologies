...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Sales Return Record')}}</li>
@endsection
@push('css-page')
    <style>
        .list-group-bg{
    ...
    {{-- <div class="row justify-content-between align-items-center mb-3">
        <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
            <div class="all-button-box">
                <a href="{{ route('pos.pos_return_pdf', Crypt::encrypt($pos->id))}}" target="_blank" class="btn btn-sm btn-primary">
                    {{__('Download')}}
                </a>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-2 list-goods">
                    ...
                    @foreach ($getPurReturnId as $goods)
                        <div class="list-group list-group-flush my-2" id="useradd-sidenav">
                            <a href="#" onclick="returnRecordFilter(this,'{{$goods->return_id}}','{{$goods->pos_id}}')" class="list-group-item list-group-item-action border-0 d-flex justifyContent list-group-bg"> 
                                <div class="left-menu">
                ...
                <div class="col-1">
                    @foreach ($getPurReturnId as $goods)
                        <div class="pt-4 pb-3">
                            <a href="{{ route('pos.pos_return_single_pdf',['unique_id' => $goods->return_id,'id' => $goods->pos_id])}}" target="_blank" class="btn btn-primary">
