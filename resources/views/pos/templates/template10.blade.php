                        ...
                        <div data-v-b8f60a0c="" class="d" style="width:710px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-b8f60a0c="" class="d-inner">
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-33"><h1 data-v-b8f60a0c="" class="fancy-title tu mb5" style="color: {{$color}}; border-top: 15px solid {{$color}};">{{__('Sales')}}</h1></div>
                                    ...
                                    <div data-v-b8f60a0c="" class="col-33">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-b8f60a0c="">
                                                ...
                                                <td data-v-b8f60a0c="" class="text-right">{{Utility::posNumberFormat($settings,$purchase->purchase_id)}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
