                        ...
                        <div data-v-37eeda86="" class="d" style="width:710px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-37eeda86="" class="d-inner">
                                    ...
                                    <div data-v-37eeda86="" class="col-2 text-right">
                                        ...
                                        <p data-v-37eeda86="">
                                            ...
                                            @if($settings['company_address']){{$settings['company_address']}}@endif
                                                ...
                                                @if(!empty($settings['tax_type']) && !empty($settings['vat_number'])){{$settings['tax_type'].' '. __('Number')}} : {{$settings['vat_number']}} @endif
                                                <br>
                                ...
                                <div data-v-37eeda86="" class="col-33">
                                    <strong data-v-37eeda86="" class="tu mb5" style="color: {{$color}};">{{__('Sales')}}</strong>
                                    <table data-v-37eeda86="" class="summary-table">
                                        <tbody data-v-37eeda86="">
                                        <tr data-v-37eeda86="">
                                            <td data-v-37eeda86="" class="tu">{{__('Number')}}:</td>
                                            <td data-v-37eeda86="" class="text-right">{{Utility::posNumberFormat($settings,$purchase->purchase_id)}}</td>
                                        </tr>
                                        <tr data-v-37eeda86="">
