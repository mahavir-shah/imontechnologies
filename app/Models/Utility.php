...
',
    ...
    public function shipNumberFormat($number)
    {
        $settings = Utility::settings();

        return $settings["shipping_prefix"] . sprintf("%05d", $number);
    }
    ...
    {
        return $settings["proposal_prefix"] . sprintf("%04d", $number);
    }
