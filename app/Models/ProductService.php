...
class ProductService extends Model
{
    ...
    {
        return ProductService::select('product_services.*', 'c.name as categoryname','priceList.msp_margin','priceList.lsp_margin','priceList.alliance','priceList.premium','priceList.standard')
            ->leftjoin('product_service_categories as c', 'c.id', '=', 'product_services.category_id')
            ->join('product_price_lists as priceList', 'priceList.product_id',
            '=','product_services.id')
